...
class proeditor extends StatefulWidget {
  final File images;
  ...
  @override
  State<proeditor> createState() => _proeditorState();
}

class _proeditorState extends State<proeditor> {
  // final _editor = GlobalKey<ProImageEditorState>();
  //
  // Future<Uint8List> loadImageBytes() async {
  //   final ByteData data = await rootBundle.load(widget.images.path);
...
//   Navigator.pop(context,widget.images.writeAsBytes(bytes));
                        },
                      ),
                    ),
                  );
